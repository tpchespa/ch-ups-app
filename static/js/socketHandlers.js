...
export function initializeSocketHandlers(socket, currentUserEmail, SwalWithDarkTheme, table) {
  socket.on("new_entry", data => {
    ...
    const rowData = {
      ...
      "Consignee Email": data.data["Consignee_Email"] || data.data["Consignee Email"] || "",
      ...
      "Docs No Value": data.data["Documents_of_No_Commercial_Value"] || data.data["Documents of No Commercial Value"] || "",
